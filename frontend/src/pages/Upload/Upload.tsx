    ...
    return (
      <div className={b()}>
        <div className={b("title-box")}>
          ...
          <Typography variant="h5" className={b("desc")}>You can see your video preview here</Typography>
          <Icon name="down-arrow" /> 
        </div>
        <Grid container spacing={3} alignContent="center" justify="center" className={ b("upload-container")}>
